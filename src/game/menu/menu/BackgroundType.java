...
public abstract class BackgroundType {
    ...
    public BackgroundType(){
        imageSrcIn = new BufferedImage(Global.WINDOW_WIDTH, Global.WINDOW_HEIGHT, BufferedImage.TYPE_INT_ARGB);
    ...
    public static class BackgroundNull extends BackgroundType {
