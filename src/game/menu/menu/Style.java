...
public abstract class Style {
    ...
    //fanny
    public static class StyleRectTest extends Style {
        ...
        //自由填滿
        public StyleRectTest(int width, int height, boolean isFill, BackgroundType background) {
            this.isFill = isFill;
            this.height = height;
            this.width = width;
            this.objectBackground = background;
        ...
        //已填滿
        public StyleRectTest(int width, int height, BackgroundType background) {
            this(width, height, true, background);
        }
